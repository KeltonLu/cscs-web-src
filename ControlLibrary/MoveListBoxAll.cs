...
namespace ControlLibrary
{
    public class MoveListBoxAll : ListBox
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (!Page.ClientScript.IsClientScriptBlockRegistered("MoveListBox"))
            {
                string clientscript = "function Add(Obj,Active,IsAll)                                                                              " +
                                    ...
                                    "    var addedHidden=Obj.parentNode.parentNode.parentNode.parentNode.rows[4].cells[0].children[0];         " +
                                    "    var deletedHidden=Obj.parentNode.parentNode.parentNode.parentNode.rows[4].cells[0].children[1];       " +
                                    "    var FromSelect,ToSelect;                                                                                " +
                                    "    if(Active=='toRight')                                                                                   " +
                                    "    {FromSelect=row.cells[0].children[0];ToSelect=row.cells[2].children[0];}                            " +
                                    "    else                                                                                                    " +
                                    "    {FromSelect=row.cells[2].children[0];ToSelect=row.cells[0].children[0];}                            " +
                                    ...
                                    "	else                                                                                                 " +
                                    "	{                                                                                                    " +
                                    "		row=Obj.parentNode.parentNode.parentNode.parentNode;table=row.rows[0].cells[1].children[0];" +
                                    "	}                                                                                                    " +
                                    "	LeftSelect=row.cells[0].children[0];RightSelect=row.cells[2].children[0];                        " +
                                    "	ToRightAdd=table.rows[0].cells[0].children[0];ToLeftAdd=table.rows[1].cells[0].children[0];      " +
                                    "	ToRightAll=table.rows[2].cells[0].children[0];ToLeftAll=table.rows[3].cells[0].children[0];      " +
        ...
        //            scriptBuilder.AppendLine("var addedHidden=Obj.parentNode.parentNode.parentNode.parentNode.rows[4].cells[0].children[0];");
        //            scriptBuilder.AppendLine("var deletedHidden=Obj.parentNode.parentNode.parentNode.parentNode.rows[4].cells[0].children[2];");
        //            scriptBuilder.AppendLine("var FromSelect,ToSelect;");
        //            scriptBuilder.AppendLine("if(Active=='toRight'){FromSelect=row.cells[0].children[0];ToSelect=row.cells[2].children[0];}");
        //            scriptBuilder.AppendLine("else{FromSelect=row.cells[2].children[0];ToSelect=row.cells[0].children[0];}");
        ...
        //            scriptBuilder.AppendLine("else{row=Obj.parentNode.parentNode.parentNode.parentNode;table=row.rows[0].cells[1].children[0];}");
        //            scriptBuilder.AppendLine("LeftSelect=row.cells[0].children[0];RightSelect=row.cells[2].children[0];");
        //            scriptBuilder.AppendLine("ToRightAdd=table.rows[0].cells[0].children[0];ToLeftAdd=table.rows[1].cells[0].children[0];");
        //            scriptBuilder.AppendLine("ToRightAll=table.rows[2].cells[0].children[0];ToLeftAll=table.rows[3].cells[0].children[0];");
