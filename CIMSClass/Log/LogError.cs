...
namespace CIMSClass
{
    public class LogError
    {
        ...
        public LogError()
        {
            string LogFilePath = ConfigurationManager.AppSettings["LogPath"] + "Error" + DateTime.Now.ToString("yyyyMMdd") + ".log";
        ...
        {   
            ...
            entry.Categories.Add(GlobalString.LogType.ErrorCategory);
