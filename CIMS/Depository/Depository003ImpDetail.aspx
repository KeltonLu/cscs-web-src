<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Depository003ImpDetail.aspx.cs" Inherits="Depository_Depository003ImpDetail" %>
        ...
        <table border="0" cellpadding="0" cellspacing="2" style="width: 100%">
            ...
            <tr class="tbl_row">
                <td>
                    <table border="0" cellpadding="0" cellspacing="2" style="width: 100%">
                        <tr valign="baseline">
                            <td style="width:20%" align="right"><font color="red">*</font>訂單流水編號：</td>
                            <td align="left">
                                <asp:DropDownList ID="dropOrderForm_Detail_RID" runat="server" DataTextField="OrderForm_Detail_RID" DataValueField="OrderForm_Detail_RID" AutoPostBack="True" OnSelectedIndexChanged="dropOrderForm_Detail_RID_SelectedIndexChanged">
                                </asp:DropDownList></td>
                        </tr>
                        <tr valign="baseline">
                        ...
                        <tr valign="baseline">
                            ...
                            <td align="left">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtStock_Number"
                        ...
                        <tr valign="baseline">
                            ...
                            <td align="left">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtBlemish_Number"
                        ...
                        <tr valign="baseline">
                            ...
                            <td align="left">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtSample_Number"
                        ...
                        <tr valign="baseline">
                            <td align="right"><font color="red">*</font>卡片批號：</td>
                            <td align="left">
                                <asp:TextBox ID="txtSerial_Number" onkeyup="LimitLengthCheck(this,25)" runat="server" onblur="LimitLengthCheck(this,25);CheckSerialNum()" MaxLength="25"></asp:TextBox>&nbsp;
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtSerial_Number"
                                    ErrorMessage="批號不能為空">*</asp:RequiredFieldValidator>&nbsp;
                            </td>
                        </tr>
                        <tr valign="baseline">
                        ...
                        <tr valign="baseline">
                            <td align="right"><font color="red">*</font>批號狀態：</td>
                            <td align="left">
