<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Depository002Detaila.aspx.cs"
                                ...
                                <table class="tbl_row" cellpadding="0" width="100%" cellspacing="2" border="0">
                                 ...
                                 <%--           <asp:TextBox ID="txtBase_price" runat="server" Style="ime-mode: disabled;
                                    ...
                                    <tr class="tbl_row" valign="baseline">
                                        ...
                                        <td>
                                            <asp:DropDownList ID="dropWafer_Name" DataTextField="text" DataValueField="value"
                                                runat="server" AutoPostBack="True" OnSelectedIndexChanged="dropWafer_Name_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr class="tbl_row" valign="baseline">
