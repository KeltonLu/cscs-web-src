...
public partial class Depository_Depository004Print : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ReportViewer1.ServerReport.ReportPath = "/CIMSReport/Depository004";


            ReportParameter[] reportParam = new ReportParameter[1];
            reportParam[0] = new ReportParameter("report_rid", strRID, false);
