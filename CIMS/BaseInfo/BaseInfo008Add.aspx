<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BaseInfo008Add.aspx.cs" Inherits="BaseInfo_BaseInfo008Add" %>

<%@ Register Src="../CommUserCtrl/uctrlCardType.ascx" TagName="uctrlCardType" TagPrefix="uc1" %>
<%@ Register Assembly="ControlLibrary" Namespace="ControlLibrary" TagPrefix="cc1" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>卡片材質基本檔新增</title>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table bgcolor="#ffffff" width="100%" align="center" cellpadding="0" cellspacing="1"
                ...
                <tr valign="baseline">
                    <td>
                        <font class="PageTitle">卡片材質基本檔新增</font>
                    </td>
                    <td align="right">
