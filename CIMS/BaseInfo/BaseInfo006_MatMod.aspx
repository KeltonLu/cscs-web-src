<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BaseInfo006_MatMod.aspx.cs"
    Inherits="BaseInfo_BaseInfo006_MatMod" %>
                        ...
                        <table width="100%" cellspacing="0">
                            <tr class="tbl_row">
                                <td align="right" width="10%" style="height: 24px">
                                    <span class="style1">*</span>參數編號：</td>
                            ...
                            <tr class="tbl_row">
                                ...
                                <td>
                                    ...
                                    <asp:RadioButton ID="radIs_Merge_N" runat="server" Checked="True" GroupName="rbgIs_Merge"
                                        Text="否" />
                                </td>
                            </tr>
                            <tr class="tbl_row">
