...
public partial class BaseInfo_BaseInfo006_CardType : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            if (strType == "1")
                lbTitle.Text = "卡片管理設定-用途群組";
            else if (strType == "2")
                lbTitle.Text = "卡片管理設定-合約級距代碼";
            else if (strType == "3")
                lbTitle.Text = "卡片管理設定-庫存原因設定";
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect(string.Concat("BaseInfo006_CardTypeAdd.aspx", GlobalString.PageUrl.ACTION_TYPE, GlobalString.ActionName.ADD, strURL));
    }
    #endregion
    ...
    protected void gvpbParameter_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            hlParam_Name.NavigateUrl = "BaseInfo006_CardTypeMod.aspx?Type=" + strType + "&ActionType=Edit&RID=" + dtblParameter.Rows[e.Row.RowIndex]["RID"].ToString().Trim();
