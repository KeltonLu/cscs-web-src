<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BaseInfo011Add.aspx.cs" Inherits="BaseInfo_BaseInfo011Add" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table bgcolor="#ffffff" width="100%" align="center" cellpadding="0" cellspacing="1"
                ...
                <tr valign="baseline">
                    <td>
                        <font class="PageTitle">庫存類別新增</font>
                    </td>
                    <td align="right">
                        <asp:Button ID="btnAddUp" OnClick="btnAddUp_click" runat="server" Text="確定" CssClass="btn" />&nbsp;&nbsp;
                        <input id="btnCancel" class="btn" onclick="returnform('BaseInfo011.aspx')" type="button"
                            value="取消" />&nbsp;
                    </td>
                </tr>
                <tr valign="baseline">
                ...
                <tr valign="baseline">
                    <td colspan="2" align="right">
                        <asp:Button ID="btnAddDown" OnClick="btnAddDown_click" runat="server" Text="確定"  CssClass="btn"/>&nbsp;&nbsp;
                        <input id="btnCancel1" class="btn" onclick="returnform('BaseInfo011.aspx')" type="button"
                            value="取消" />
                    </td>
                </tr>
            </table>
