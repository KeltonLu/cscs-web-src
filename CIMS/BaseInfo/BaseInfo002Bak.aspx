<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BaseInfo002Bak.aspx.cs" Inherits="BaseInfo_BaseInfo002Bak" %>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                        ...
                        <tr valign="baseline">
                            <td>
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                    <td>
                                        <font class="PageTitle">備援合約設定</font>
                                    </td>
                                    <td align="right">
                                                        ...
                                                        <table cellpadding="0" width="100%" cellspacing="2" border="0">
                                                            <tr valign="baseline">
                                                                ...
                                                                <td style="width: 35%" align="left">
                                                                    <asp:TextBox onblur="LimitLengthCheck(this,20)" onkeyup="LimitLengthCheck(this,20)"
                                                                        ID="txtAgreement_Code" runat="server" MaxLength="20"></asp:TextBox>
                                                                    ...
                                                                    <cc1:AjaxValidator ID="AjaxValidator1" runat="server" ControlToValidate="txtAgreement_Code"
                                                                        ErrorMessage=" 重複的合約編號" OnOnAjaxValidatorQuest="AjaxValidator1_OnAjaxValidatorQuest"></cc1:AjaxValidator></td>
                                                                <td style="width: 10%" align="right">
                                                                    <span class="style1">*</span>合約名稱：
                                                                </td>
                                                                <td align="left">
                                                                    <asp:TextBox onblur="LimitLengthCheck(this,30)" onkeyup="LimitLengthCheck(this,30)"
                                                                        ID="txtAgreement_Name" runat="server" MaxLength="30"></asp:TextBox>
                                                ...
                                                <tr class="tbl_row">
                                                    <td>
                                                        <cc1:GridViewPageingByDB ID="gvpbCardPrice" runat="server" OnOnSetDataSource="gvpbCardPrice_OnSetDataSource"
                                                            ...
                                                            PreviousPageText="<" OnRowDataBound="gvpbCardPrice_RowDataBound" ColumnsHeaderText=""
                                                            ...
                                                            <EmptyDataTemplate>
                                                                <table cellspacing="0" cellpadding="0" border="1" style="width: 100%; border-collapse: collapse;">
                                                                    <tr style="color: Black; background-color: #B9BDAA; font-size: Small;">
                                                                        <th scope="col" style="width: 20%;">卡種組合</th>
                                                                        <th scope="col">計價方式</th>
