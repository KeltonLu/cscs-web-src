...
public partial class BaseInfo_BaseInfo006_FinanceMod : PageBase
{
    BaseInfo006BL bizLogic = new BaseInfo006BL();
    public string strType = "";
    public string strURLPath = "BaseInfo006_Finance.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            strURLPath += "?Type=1";
            lbTitle.Text = "代碼管理-卡片用途群組修改/刪除";
        }
        else if (strType == "2")
        {
            strURLPath += "?Type=2";
            lbTitle.Text = "代碼設定-合約級距修改/刪除";
        }
        else if (strType == "3")
        {
            strURLPath += "?Type=3";
            lbTitle.Text = "紙品物料庫存原因修改/刪除";
        }
        else if (strType == "4")
        {
            strURLPath += "?Type=4";
            lbTitle.Text = "代製費用帳務異動項目設定修改/刪除"; 
        }
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (chkDel.Checked)         //刪除
            {
                ...
                ShowMessageAndGoPage(BizMessage.BizCommMsg.ALT_CMN_DeleteSucc, "BaseInfo006_Finance.aspx?Con=1&Type=" + strType);
            }
            else                        //修改 
            {
                ...
                ShowMessageAndGoPage(BizMessage.BizCommMsg.ALT_CMN_SaveSucc, "BaseInfo006_Finance.aspx?Con=1&Type=" + strType);
            }
        }
        catch (Exception ex)
        {
