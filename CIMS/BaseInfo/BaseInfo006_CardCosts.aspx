<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BaseInfo006_CardCosts.aspx.cs" Inherits="BaseInfo_BaseInfo006_CardCosts" %>
<%@ Register Assembly="ControlLibrary" Namespace="ControlLibrary" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>卡片成本帳務期間設定</title>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table border="0" cellpadding="0" cellspacing="2" style="width: 100%">
                ...
                <tr valign="baseline">
                    <td>
                        <font class="PageTitle">卡片成本帳務期間設定</font>
                    </td>
                </tr>
                <tr>
                    <td>
                                            ...
                                            <cc1:GridViewPageingByDB ID="gvpbParameter" runat="server" AllowPaging="True" OnOnSetDataSource="gvpbParameter_OnSetDataSource"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="參數值">
                                                        ...
                                                        <itemtemplate>
<asp:TextBox id="txtParam_Name" runat="server" width="50px" MaxLength="2"></asp:TextBox>
</itemtemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="備註">
                                                        <itemstyle width="70%" HorizontalAlign="Center" />
                                                        <itemtemplate>
<asp:TextBox id="txtParam_Comment" runat="server" width="600px" MaxLength="500"></asp:TextBox>
</itemtemplate>
                                                    </asp:TemplateField>
                                                </Columns>
