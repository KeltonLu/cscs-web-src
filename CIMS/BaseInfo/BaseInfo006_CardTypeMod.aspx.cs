...
public partial class BaseInfo_BaseInfo006_CardTypeMod : PageBase
{
    BaseInfo006BL bizLogic = new BaseInfo006BL();
    public string strType = "";
    public string strURLPath = "BaseInfo006_CardType.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            strURLPath += "?Type=2";
            lbTitle.Text = "卡片管理設定-合約級距代碼修改/刪除";
        }
        else if (strType == "3")
        {
            strURLPath += "?Type=3";
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (chkDel.Checked)         //刪除
            {
                ...
                ShowMessageAndGoPage(BizMessage.BizCommMsg.ALT_CMN_DeleteSucc, "BaseInfo006_CardType.aspx?Con=1&Type=" + strType);
            }
            else                        //修改 
            {
                ...
                ShowMessageAndGoPage(BizMessage.BizCommMsg.ALT_CMN_SaveSucc, "BaseInfo006_CardType.aspx?Con=1&Type=" + strType);
            }
        }
        catch (Exception ex)
        {
