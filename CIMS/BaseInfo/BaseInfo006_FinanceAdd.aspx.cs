...
public partial class BaseInfo_BaseInfo006_FinanceAdd : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (strType == "1")
        {
            ...
            strURLPath += "?Type=1";
            lbTitle.Text = "代碼管理-卡片用途群組新增";
        }
        else if (strType == "2")
        {
            strParamType_Code = GlobalString.ParameterType.CardType;
            strURLPath += "?Type=2";
            lbTitle.Text = "代碼設定-合約級距新增";
        }
        else if (strType == "3")
        {
            strParamType_Code = GlobalString.ParameterType.MatType1;
            strURLPath += "?Type=3";
            lbTitle.Text = "代碼設定-紙品物料庫存原因新增";
        }
        else if (strType == "4")
        {
            strParamType_Code = GlobalString.ParameterType.Finance;
            strURLPath += "?Type=4";
            lbTitle.Text = "代製費用帳務異動項目設定新增";
        }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string strType = Request.QueryString["Type"];
            string strURL = "BaseInfo006_FinanceAdd.aspx";
