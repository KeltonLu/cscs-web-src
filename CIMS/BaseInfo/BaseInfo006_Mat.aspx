<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BaseInfo006_Mat.aspx.cs" Inherits="BaseInfo_BaseInfo006_Mat" %>
                                        ...
                                        <td>
                                            <cc1:GridViewPageingByDB ID="gvpbParameter" runat="server" AllowPaging="True" OnOnSetDataSource="gvpbParameter_OnSetDataSource"
                                                ...
                                                <Columns> 
                                                    ...
                                                    <asp:TemplateField HeaderText="參數編號" SortExpression="Param_Code">
                                                        <itemstyle horizontalalign="Left" width="15%" />
                                                        <itemtemplate>
                                                            <asp:HyperLink id="hlParam_Name" runat="server"></asp:HyperLink>
                                                        </itemtemplate>
                                                    </asp:TemplateField>
                                                     <asp:BoundField DataField="Param_Name" HeaderText="參數名稱" SortExpression="Param_Name" />
                                                    <asp:BoundField DataField="Is_Merge" HeaderText="合併計算" SortExpression="Is_Merge" />
