...
public partial class BaseInfo_BaseInfo006_Use : PageBase
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect(string.Concat("BaseInfo006_UseAdd.aspx", GlobalString.PageUrl.ACTION_TYPE, GlobalString.ActionName.ADD, strURL));
    }
    #endregion
    ...
    protected void gvpbParameter_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            hlParam_Name.NavigateUrl = "BaseInfo006_UseMod.aspx?Type=" + strType + "&ActionType=Edit&RID=" + dtblParameter.Rows[e.Row.RowIndex]["RID"].ToString().Trim();
