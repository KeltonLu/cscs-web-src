<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CardType005SpecialDetail_Percentage.aspx.cs" Inherits="CardType_CardType005SpecialDetail_Percentage" %>
							                ...
							                <td>
                                                &nbsp;<asp:TextBox ID="txtPercentageValue" runat="server" Width="100px" MaxLength="3"></asp:TextBox><asp:RequiredFieldValidator
                                                    ...
                                                    ErrorMessage="比率不能為空">*</asp:RequiredFieldValidator><asp:RegularExpressionValidator
                                                        ...
                                                        ErrorMessage="比率欄位请输入为非零的正整数的數值!" ValidationExpression="^\+?[1-9][0-9]*$" SetFocusOnError="True">*</asp:RegularExpressionValidator></td>
							            </tr>  							                                                                                                                         
							        </table>
							    </td>
							</tr>
