<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CardType005SpecialDetail_Number.aspx.cs" Inherits="CardType_CardType005SpecialDetail_Number" %>
							    ...
							    <td>
							        <table class="tbl_row" cellpadding="0" width="100%" cellspacing="2" border="0">							                                                
							            ...
							            <tr id="tr2" class="tbl_row" valign="baseline">
							                ...
							                <td>
                                                &nbsp;<asp:TextBox ID="txtNumberValue" runat="server" Width="100px" MaxLength="9"></asp:TextBox><asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtNumberValue"
