<%@ Page EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeFile="Materiel003Add.aspx.cs"
    Inherits="Materiel_Materiel003Add" %>
...
<script language="javascript" type="text/javascript">
    ...
    // 將"radioSafeType" 改為 "storageNum", 因無此ID"radioSafeType", Legend 2016/10/08
    function checkRadio() {
        if (document.getElementById("storageNum").checked) {
            document.getElementById("storageNum").checked = true;
            document.getElementById("daysNum").checked = false;
            document.getElementById("overNum").checked = false;

            document.getElementById("txtStorageNum").disabled = "";
            document.getElementById("txtDays").disabled = "true";
            document.getElementById("txtDays").value = "";
        }
        else if (document.getElementById("daysNum").checked) {
            document.getElementById("storageNum").checked = false;
            document.getElementById("daysNum").checked = true;
            document.getElementById("overNum").checked = false;
            ...
            document.getElementById("storageNum").checked = false;
            document.getElementById("daysNum").checked = false;
            document.getElementById("overNum").checked = true;
                    ...
                    <td colspan="2">
                        <table cellpadding="0" width="100%" cellspacing="0" border="0">
                            <tr class="tbl_row">
                                ...
                                <td>
                                    <asp:TextBox ID="txtName" onkeyup=" LimitLengthCheck(this, 30)" runat="server" MaxLength='30'></asp:TextBox><asp:RequiredFieldValidator
                                        ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtName" ErrorMessage="品名不能為空">*</asp:RequiredFieldValidator>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;使用狀態：<input
                                            id="usingRadio" name="stopUse" runat="server" type="radio" value="N" checked />使用&nbsp;&nbsp;<input
                            ...
                            <tr class="tbl_row">
                                ...
                                <td>
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;帳務類別：
                                    <input id="adrtCard" runat="server" type="radio" value="1" name="AccountType"  checked/>
                                    信用卡帳&nbsp;&nbsp;
                                    <input id="adrtBlank" runat="server" type="radio" value="2" name="AccountType" />銀行帳
                                </td>
                            </tr>
                            <tr class="tbl_row">
                                <td align="right">
                            ...
                            <tr class="tbl_row">
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="有效期間（起）不能為空"
                                        ControlToValidate="txtBegin_Date">*</asp:RequiredFieldValidator>
                            ...
                            <tr class="tbl_row">
                                <td align="right">
                                    ...
                                    <input type="radio" id="TypePart" runat="server" name="Card_Type_Link_Type" value="2"
                                        checked onclick="setEnabled();" />部分</td>
                                <td align="left">&nbsp;</td>
                            </tr>
                            <tr class="tbl_row">
                                <td colspan="2">
                                ...
                                <td>
                                    ...
                                    <input id="storageNum" name="radioSafeType" onclick="onStorage();" runat="server"
                                        type="radio" value="1" checked />最低安全庫存<asp:TextBox ID="txtStorageNum" runat="server"
                                            MaxLength='7' onfocus="DelDouhao(this)" onblur="value=GetValue(this.value)" Style="text-align: right"
                                    ...
                                    <input id="daysNum" type="radio" onclick="onDays();" name="radioSafeType" runat="server"
                                        value="2" />安全天數<asp:TextBox ID="txtDays" runat="server" MaxLength='3' Style="text-align: right"
                                            onkeyup="CheckNum('txtDays')" disabled="true"></asp:TextBox>天<br />
