<%@ Page EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeFile="Materiel002Add.aspx.cs"
    Inherits="Materiel_Materiel002Add" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="2" border="0" bgcolor="#ffffff">
                                        <tr class="tbl_row" valign="baseline">
                                            ...
                                            <td style="width: 70%">
                                                ...
                                                <asp:HyperLink ID="HyperLink" runat="server" Visible="false" Target="_blank"></asp:HyperLink></td>
                                            <td style="width: 15%">
                                            </td>
                                        </tr>
                                        <tr class="tbl_row" valign="baseline">
                ...
                <tr valign="baseline">
                    <td align="right" colspan="2" id="txtSafe_Number">
                        <input id="radSafe_Type" runat="server" type="hidden" value="0" />
                        <input id="txtSafe_Number" runat="server" type="hidden" value="0" />
