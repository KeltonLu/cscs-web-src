<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Finance0011Add_1.aspx.cs"
    Inherits="Finance_Finance0011Add_1" %>
<%@ Register Assembly="ControlLibrary" Namespace="ControlLibrary" TagPrefix="cc1" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>請款放行作業拆單確認</title>
    ...
    <form id="form1" runat="server">
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <table bgcolor="#ffffff" width="100%" align="center" cellpadding="0" cellspacing="1"
                ...
                <tr valign="baseline">
                    <td>
                        <font class="PageTitle">請款放行作業拆單確認</font>
                    </td>
                    <td align="right">
                ...
                <tr>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        ...
                        <table width="100%">
                            <tr>
                                <td colspan="15">
                                    <cc1:GridViewPageingByDB ID="gvpbSplitWork" runat="server" AllowSorting="True" AutoGenerateColumns="False" FirstPageText="<<"
                                        ...
                                        EditButtonText="編輯" EditCellWidth="48px" EditPageUrl="#" OnOnSetDataSource="gvpbSplitWork_OnSetDataSource" OnRowDataBound="gvpbSplitWork_RowDataBound">
...
<asp:TextBox onblur="CheckAmtWithNoId(this,5,4);value=GetValue(this.value)" onfocus="DelDouhao(this)" id="txtUnit_Price" onkeyup="CheckAmtWithNoId(this,5,4)" style="ime-mode:disabled;text-align: right" MaxLength="11" runat="server" Width="100px"  AutoPostBack="True" OnTextChanged="txtUnit_Price_TextChanged" __designer:wfdid="w14"></asp:TextBox> 
</itemtemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="Unit_Price1" HeaderText="未稅單價" DataFormatString="{0:N4}" HtmlEncode="False">
                                                <itemstyle horizontalalign="right"></itemstyle>
                                            </asp:BoundField>
                                            <asp:TemplateField HeaderText="實際請款數量">
                                                <itemtemplate>
                                                        <%--Dana 20161021 最大長度由 9 改為 11 --%>
<asp:TextBox onblur="CheckNumWithNoId1(this,9);value=GetValue(this.value)"  onfocus="DelDouhao(this)"  id="txtRequisition_Count" onkeyup="CheckNumWithNoId1(this,9)" style="ime-mode:disabled;text-align: right" MaxLength="11" runat="server" Width="100px" AutoPostBack="True" OnTextChanged="txtRequisition_Count_TextChanged" __designer:wfdid="w3"></asp:TextBox> 
</itemtemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField HeaderText="含稅總金額" />
                                            ...
                                            <asp:TemplateField HeaderText="備註">
                                                <itemtemplate>
<asp:TextBox id="txtComment" runat="server" __designer:wfdid="w4"></asp:TextBox> 
</itemtemplate>
                                            </asp:TemplateField>
                                        </Columns>
