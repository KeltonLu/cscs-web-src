...
public partial class CommUserCtrl_urctrlCardNameSelect : System.Web.UI.UserControl
{
    ...
    private bool _IsShowAllCard = false;

    public bool IsShowAllCard
    {
        set
        {
            _IsShowAllCard = value;
        }
    }
    ...
    protected void dropCard_TypeBind()
    {
        ...
        if (StringUtil.IsEmpty(dropCard_Group.SelectedValue))
        {
            if (_CardTypeAll)
            {
        ...
        {
            dropCard_Type.DataTextField = "Name";
