...
public partial class CommUserCtrl_uctrlCardType3 : System.Web.UI.UserControl
{
    ...
    {
        //this.rdoGroup.Attributes.Add("onclick", "Choice();");
        //this.rdoCard.Attributes.Add("onclick", "Choice();");
        if (!IsPostBack)
        {
            ...
            LbLeftBind();
            DelLeftItem();
            //if (this.rdoGroup.Checked)
            //    this.plBox.Visible = false;
            //if (this.rdoCard.Checked)
            //    this.plBox.Visible = true;
    ...
    {
        int i;
        for (i = 1998; i <= 2028; i++)  // 2018改為2028 add judy 2018/05/03
        {
    ...
    protected void rdoCard_CheckedChanged(object sender, EventArgs e)
    {
        this.plBox.Visible = true;
    }
}
