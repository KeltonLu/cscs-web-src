...
{
    InOut005BL blManager = new InOut005BL();
    ...
    protected void btnImport_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                //blManager.FileCheck(Convert.ToInt16(ddlYear.SelectedItem.Text), Convert.ToInt16(ddlMonth.SelectedItem.Text));
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        Response.Write("<script>window.open('InOut005Print.aspx?Deplete=" + txtDeplete.Text + "&time=" + timeMark + "','_blank','status=no,menubar=no,location=no,scrollbars=no,resizable=yes,width=1000,height=550');</script>");
    }
    protected void gvpbChangeCard_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            e.Row.Cells[1].Text = e.Row.Cells[2].Text + "-" + e.Row.Cells[3].Text + "-" + e.Row.Cells[4].Text;
