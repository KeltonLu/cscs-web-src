<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="InOut008.aspx.cs" Inherits="InOut_InOut004" %>
        ...
        <div>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                ...
                <tr valign="baseline" style="font-size: 12pt">
                    <td class="PageTitle" style="height: 19px;" colspan="2">次月下市預測表匯入
                    </td>
                </tr>
                ...
                <tr class="tbl_row" id='trInyear' style="display: table-row">
                    <td colspan="3" style="height: 26px;">
                        <span class="style1" style="color: #000000"><span style="font-size: 9pt; color: #ff0000">*</span>匯入年：</span><asp:DropDownList ID="ddlYear" runat="server">
                ...
                <tr id="trSearch2" class="tbl_row" style="font-size: 12pt" valign="baseline">
                    <td colspan="2" style="height: 19px">&nbsp;Perso廠：<asp:DropDownList ID="dropFactory_Name" runat="server" DataTextField="Factory_ShortName_CN"
                        DataValueField="RID">
                    </asp:DropDownList></td>
                </tr>
                    ...
                    <td colspan="2" style="height: 19px">
                        <cc1:GridViewPageingByDB ID="gvpbChangeCard" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Disney_Code" HeaderText="Disney_Code">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle HorizontalAlign="Center" />
                                </asp:BoundField>
